...
import WhyChooseUs from "@/app/components/aboutSection/whyChooseUs";
import Achievements from "@/app/components/aboutSection/achievements";
import MoreAbout from "@/app/components/aboutSection/moreAbout";
import VisionMissionSection from "@/app/components/aboutSection/vision";
        ...
        <div className="Contact-section relative flex flex-col items-center justify-center  pb-16 px-4 sm:px-8 lg:px-12 overflow-hidden">
          ...
          <div className="relative z-20 text-center max-w-5xl pt-32 ">
            ...
            <p className="mt-6 text-white text-opacity-80 font-sans text-base leading-7 md:text-lg">
              Discover who we are, what drives us, and why we&apos;re the best choice
              for you.{" "}
            </p>
          </div>
        </div>
